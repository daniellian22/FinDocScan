...
**FinDocScan** is a document scanning and financial data extraction web application. Users can upload financial documents (e.g., receipts, invoices), and the app uses OpenAI's GPT and OCR to extract key structured information.
